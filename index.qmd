...
::: {.column width="50%"}
::: fragment
### "Publishing system" by Posit ^[(company formerly known as RStudio)]
...
<iframe src="https://hedgedoc.org" width="100%" height="500px"></iframe>
:::
:::
:::
...
::: fragment
The YAML header of [these slides]({{< var source >}}/blob/main/index.qmd#L1-L12):
...
1. Inside the repository have a `recipes.qmd` file and (optionally) a `.gitignore` file
1. Inside the `recipes.qmd` file, share at least one recipe.
