...
1.    Create a new **empty Quarto file** called `{{< var course-project >}}.qmd` in RStudio and save it in your `{{< var course-project >}}` repository
...
1.    **Add a new entry** to the `{{< var course-project >}}.qmd` file (quickly copy-paste from the web)
...
1.  Ensure you have a Git repository named `{{< var course-project >}}` set up on your computer
2.  Inside the repository have a `{{< var course-project >}}.qmd` file and (optionally) a `.gitignore` file
3.  Inside the `{{< var course-project >}}.qmd` file, share at least one new entry.
