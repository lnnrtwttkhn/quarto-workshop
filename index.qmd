...
::: notes
2.  Very new (2022) Created by rstudio´s creators - like r markdown but for even more features E.g. Python code, Javascript, languages that dont even exist yet able to render markdown files
...
::: notes
Markup Language. = text encoding system readable by machine Pros: easier to use for quick notes, faster to write since format and content intertwined, and version control, faster - less loading cons: less formatting options since its intentionally simple, e.g. tables pretty complex to do, or pictures less intuitive (once used to word)

Used by: GitHub, Slack Discord, Reddit Hedgedoc = open source markdown editor Formerly knows as CodiMD
...
-   Copy paste a **recipe** from the web **into your file**
...
::: notes
YAML: Datenformat in konfiguartionsdateien, noch viele andere Anwendungsmöglichkeiten, Metadata for files, today only author, title and output format and Theme Could also do e.g. date\_:
:::
...
11 - [Official Quarto Documentation](https://quarto.org)
