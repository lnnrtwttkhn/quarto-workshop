...
::: fragment
:bulb: Learn the basics of Markdown syntax <br>
:::

::: fragment
:bulb: Work on a new `quarto` branch in your recipes repo <br>
:::

::: fragment
:bulb: Create a neat quarto recipe file <br>
:::

::: fragment
:bulb: Merge your new file into your main branch
:::

::: fragment
- Your quarto file can later be turned into a website!
:::
...
::: fragment
![Image from [Hello Quarto Presentation](https://mine.quarto.pub/hello-quarto/#/publishing-system-2) from  [Mine Çetinkaya-Rundel PhD](https://mine-cr.com)](images/quarto_illustration.png){#fig-quarto}
:::
...
::: fragment
{{< fa display >}} [Table Generator](https://www.tablesgenerator.com/markdown_tables)
:::
...
-   **Stage** and **Commit** your changes
-   **Merge** your "quarto" branch into your main branch
...
| ```                                          |                                                              |
+----------------------------------------------+--------------------------------------------------------------+
| ```                                          | Blip blop bloop [@ggseg; @chacon2014]. \|                    |
| Blip blop bloop [@ggseg; @chacon2014].       |                                                              |
| ```                                          |                                                              |
+----------------------------------------------+--------------------------------------------------------------+
| ```                                          | Mowinckel says blah [-@chacon2014]                           |
| Mowinckel says blah [-@chacon2014]           |                                                              |
| ```                                          |                                                              |
+----------------------------------------------+--------------------------------------------------------------+
